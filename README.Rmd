...
The `bplsr` package implements the Bayesian partial least squares regression model. It is a Bayesian factor model which emulates the partial least squares (PLS) method.
...
The following example illustrates how to carry out multivariate regression using BPLS:
